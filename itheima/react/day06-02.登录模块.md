...
![image.png](assets/03-20240504032629-7vposqd.png)
...
![image.png](assets/04-20240504032629-p0lrfn8.png)
**实现步骤**
...
![image.png](assets/05-20240504032629-y7r38lt.png)
...
![image.png](assets/06-20240504032629-6ixxnie.png)

# 请求拦截器注入token

> 业务背景: Token作为用户的数据标识，在接口层面起到了接口权限控制的作用，也就是说后端有很多接口都需要通过查看当前请求头信息中是否含有token数据，来决定是否正常返回数据

![token.png](assets/07-20240504032629-oug0z0t.png)
