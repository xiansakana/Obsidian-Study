...
![image-20230506094411247](https://cdn.jsdelivr.net/npm/itheima-java-mianshi/image-20230506094411247.png)
...
![image-20230506094602329](https://cdn.jsdelivr.net/npm/itheima-java-mianshi/image-20230506094602329.png)
...
![image-20230506094938843](https://cdn.jsdelivr.net/npm/itheima-java-mianshi/image-20230506094938843.png)
...
3. 方法内的局部变量是否线程安全？
   ...
   - 比如以下代码：
     ...
     ![image-20230506095306061](https://cdn.jsdelivr.net/npm/itheima-java-mianshi/image-20230506095306061.png)

**栈内存溢出情况**

- 栈帧过多导致栈内存溢出，典型问题：递归调用

  ![image-20230506095401637](https://cdn.jsdelivr.net/npm/itheima-java-mianshi/image-20230506095401637.png)
...
![image-20230506100142724](https://cdn.jsdelivr.net/npm/itheima-java-mianshi/image-20230506100142724.png)
...
![image-20230506100501905](https://cdn.jsdelivr.net/npm/itheima-java-mianshi/image-20230506100501905.png)
...
![image-20230506100548455](https://cdn.jsdelivr.net/npm/itheima-java-mianshi/image-20230506100548455.png)
...
![](https://cdn.jsdelivr.net/npm/itheima-java-mianshi/image-20220903233627146.png)
...
![image-20230506100746624](https://cdn.jsdelivr.net/npm/itheima-java-mianshi/image-20230506100746624.png)
...
![image-20230506100920042](https://cdn.jsdelivr.net/npm/itheima-java-mianshi/image-20230506100920042.png)
...
![image-20230506101032605](https://cdn.jsdelivr.net/npm/itheima-java-mianshi/image-20230506101032605.png)

**类加载过程详解**

1.加载

![image-20230506101115674](https://cdn.jsdelivr.net/npm/itheima-java-mianshi/image-20230506101115674.png) 
...
![image-20230506101213373](https://cdn.jsdelivr.net/npm/itheima-java-mianshi/image-20230506101213373.png)

2.验证

![image-20230506101420202](https://cdn.jsdelivr.net/npm/itheima-java-mianshi/image-20230506101420202.png)
...
![image-20230506101445898](https://cdn.jsdelivr.net/npm/itheima-java-mianshi/image-20230506101445898.png)
...
![image-20230506101625087](https://cdn.jsdelivr.net/npm/itheima-java-mianshi/image-20230506101625087.png)
...
![image-20230506101641837](https://cdn.jsdelivr.net/npm/itheima-java-mianshi/image-20230506101641837.png)
...
![image-20230506104954777](https://cdn.jsdelivr.net/npm/itheima-java-mianshi/image-20230506104954777.png)
...
![image-20230506111102825](https://cdn.jsdelivr.net/npm/itheima-java-mianshi/image-20230506111102825.png)
...
![image-20230506111255401](https://cdn.jsdelivr.net/npm/itheima-java-mianshi/image-20230506111255401.png)

先执行右侧代码的前4行代码

![image-20230506111327590](https://cdn.jsdelivr.net/npm/itheima-java-mianshi/image-20230506111327590.png)
...
![image-20220904010634153](https://cdn.jsdelivr.net/npm/itheima-java-mianshi/image-20220904010634153.png)
...
![image-20230506111919008](https://cdn.jsdelivr.net/npm/itheima-java-mianshi/image-20230506111919008.png)
...
![image-20230506131442503](https://cdn.jsdelivr.net/npm/itheima-java-mianshi/image-20230506131442503.png)

- 经过一段时间后伊甸园的内存又出现不足，标记eden区域to区存活的对象，将存活的对象复制到from区

![image-20230506131544447](https://cdn.jsdelivr.net/npm/itheima-java-mianshi/image-20230506131544447.png)

- 当幸存区对象熬过几次回收（最多15次），晋升到老年代（幸存区内存不足或大对象会导致提前晋升）

**MinorGC、 Mixed GC 、 FullGC的区别是什么**

![image-20230506131640893](https://cdn.jsdelivr.net/npm/itheima-java-mianshi/image-20230506131640893.png)
...
![image-20230506154117857](https://cdn.jsdelivr.net/npm/itheima-java-mianshi/image-20230506154117857.png)
...
- 当伊甸园需要垃圾回收时，挑出一个空闲区域作为幸存区，用复制算法复制存活对象，需要暂停用户线程
  ...
  ![image-20230506154633118](https://cdn.jsdelivr.net/npm/itheima-java-mianshi/image-20230506154633118.png)

  ![image-20230506154705088](https://cdn.jsdelivr.net/npm/itheima-java-mianshi/image-20230506154705088.png)

- 随着时间流逝，伊甸园的内存又有不足

- 将伊甸园以及之前幸存区中的存活对象，采用复制算法，复制到新的幸存区，其中较老对象晋升至老年代

  ![image-20230506154759809](https://cdn.jsdelivr.net/npm/itheima-java-mianshi/image-20230506154759809.png)
...
![image-20230506155341703](https://cdn.jsdelivr.net/npm/itheima-java-mianshi/image-20230506155341703.png)
...
![image-20230506155416293](https://cdn.jsdelivr.net/npm/itheima-java-mianshi/image-20230506155416293.png)
...
![image-20230506155501557](https://cdn.jsdelivr.net/npm/itheima-java-mianshi/image-20230506155501557.png)
...
![image-20230506155518510](https://cdn.jsdelivr.net/npm/itheima-java-mianshi/image-20230506155518510.png)
...
![image-20220904104739581](https://cdn.jsdelivr.net/npm/itheima-java-mianshi/image-20220904104739581.png)
...
![image-20220904114511854](https://cdn.jsdelivr.net/npm/itheima-java-mianshi/image-20220904114511854.png)
...
![image-20220904120057211](https://cdn.jsdelivr.net/npm/itheima-java-mianshi/image-20220904120057211.png)
...
![image-20220904132134095](https://cdn.jsdelivr.net/npm/itheima-java-mianshi/image-20220904132134095.png)

查看堆中的信息

![image-20220904132346495](https://cdn.jsdelivr.net/npm/itheima-java-mianshi/image-20220904132346495.png)
...
![image-20230506155704119](https://cdn.jsdelivr.net/npm/itheima-java-mianshi/image-20230506155704119.png)
...
![image-20220904161818255](https://cdn.jsdelivr.net/npm/itheima-java-mianshi/image-20220904161818255.png)
...
>`printf "%x\n" 30979`
>
>![image-20220904162654928](https://cdn.jsdelivr.net/npm/itheima-java-mianshi/image-20220904162654928.png)
...
![image-20220904162941977](https://cdn.jsdelivr.net/npm/itheima-java-mianshi/image-20220904162941977.png)
