...
* 创建SpringBoot工程
  ...
  ![1630997819698](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1630997819698.png)

* 勾选配置使用的技术，能够实现自动添加起步依赖包

  ![1630997860020](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1630997860020.png)

* 设置dataSource相关属性(JDBC参数)

  ![1630997901479](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1630997901479.png)

* 定义数据层接口映射配置

  ![1630997929891](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1630997929891.png)
...
![1630998241426](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1630998241426.png)

#### 步骤3:勾选配置使用技术

![1630998321660](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1630998321660.png)
...
* 从MP的依赖关系可以看出，通过依赖传递已经将MyBatis与MyBatis整合Spring的jar包导入，我们不需要额外在添加MyBatis的相关jar包
  ...
  ![1631206757758](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631206757758.png)
...
![1630999646096](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1630999646096.png)
...
![1631011942323](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631011942323.png)

现在的页面中，这一行已经被删除，现在再去访问`https://mybatis.plus`会发现访问不到，这个就有很多可能性供我们猜想了，所以大家使用baomidou的网址进行访问即可。

官方文档中有一张很多小伙伴比较熟悉的图片:

![1631012174092](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631012174092.png)
...
![1631018877517](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631018877517.png)
...
![1631013124310](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631013124310.png)
...
* Serializable：参数类型
  ...
  * 思考:参数类型为什么是一个序列化类?
    ...
    ![1631013655771](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631013655771.png)
...
![1631016543648](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631016543648.png)
...
![1631016876641](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631016876641.png)
...
![1631208030131](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631208030131.png)

#### 步骤3:运行测试程序

![1631019660480](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631019660480.png)
...
![1631019896688](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631019896688.png)
...
![1631020283701](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631020283701.png)
...
* 编写测试类
  ...
  ![1631033477792](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631033477792.png)
...
* 测试的时候，控制台打印的日志比较多，速度有点慢而且不利于查看运行结果，所以接下来我们把这个日志处理下:
  ...
  * 取消MybatisPlus启动banner图标
    ...
    ![1631021315906](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631021315906.png)
  ...
  * 取消SpringBoot的log打印
    ...
    ![1631021269422](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631021269422.png)
...
![1631021942869](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631021942869.png)
...
![1631023641992](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631023641992.png)
...
![1631024145264](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631024145264.png)
...
* lt()方法
  ...
  ![1631025068317](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631025068317.png)
...
![1631209838333](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631209838333.png)
...
![1631030296965](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631030296965.png)
...
![1631030550100](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631030550100.png)
...
![1631031054206](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631031054206.png)
...
![1631031270558](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631031270558.png)
...
![1631031828378](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631031828378.png)

解决方案是使用MP提供的另外一个注解`@TableName`来设置表与模型类之间的对应关系。

![1631031915632](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631031915632.png)
...
![1631032123894](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631032123894.png)
...
![1631032283147](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631032283147.png)
...
![1631032450558](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631032450558.png)
...
- 最终创建的项目结构为:
  ...
  ![1631033634879](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631033634879.png)
...
* 删除测试数据
  ...
  ![1631211291677](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631211291677.png)

* 因为之前生成主键ID的值比较长，会把MySQL的自动增长的值变的很大，所以需要将其调整为目前最新的id值。

![1631211080703](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631211080703.png)

###### 步骤3:运行新增方法  

会发现，新增成功，并且主键id也是从5开始

![1631211383421](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631211383421.png)
...
![1631211697712](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631211697712.png)

当把源码下载完后，就可以看到如下内容:

![1631211902833](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631211902833.png)
...
![1631212246124](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631212246124.png)
...
![1631212469974](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631212469974.png)

如果设置了主键ID,则数据添加成功，如下:

![1631212421137](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631212421137.png)
...
![1631242753467](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631242753467.png)
...
![1631243694870](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631243694870.png)
...
![1631243810974](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631243810974.png)
...
![1631243987800](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631243987800.png)
...
对于主键ID的策略已经介绍完，但是如果要在项目中的每一个模型类上都需要使用相同的生成策略，如:![1631245676125](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631245676125.png)
...
![1631245757169](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631245757169.png)
...
![1631246166514](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631246166514.png)
...
![1631246688218](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631246688218.png)

### 4.3 逻辑删除

接下来要讲解是删除中比较重要的一个操作，逻辑删除，先来分析下问题:

![1631246806130](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631246806130.png)
...
* 如果表在设计的时候有主外键关系，那么同时也得将合同表中的前三条数据也删除掉
  ...
  ![1631246997190](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631246997190.png)
...
* 所以经过分析，我们不应该将表中的数据删除掉，而是需要进行保留，但是又得把离职的人和在职的人进行区分，这样就解决了上述问题，如:
  ...
  ![1631247188218](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631247188218.png)
...
![1631247439168](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631247439168.png)
...
![1631247818327](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631247818327.png)
...
* 执行查询操作
  ...
  ![1631248019999](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631248019999.png)
...
![1631248494929](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631248494929.png)
...
![1631249913103](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631249913103.png)
...
![1631252305080](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631252305080.png)
...
![1631252393659](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631252393659.png)
...
![1631252667865](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631252667865.png)
...
![1631253302587](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631253302587.png)
...
![1631253387845](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631253387845.png)

## 5，快速开发

### 5.1 代码生成器原理分析

造句:![1631253928893](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631253928893.png)

我们可以往空白内容进行填词造句，比如:![1631253971409](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631253971409.png)

在比如:![1631253994782](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631253994782.png)

观察我们之前写的代码，会发现其中也会有很多重复内容，比如:

![1631254075651](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631254075651.png)

那我们就想，如果我想做一个Book模块的开发，是不是只需要将红色部分的内容全部更换成`Book`即可，如：

![1631254119948](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631254119948.png)
...
![1631254344180](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631254344180.png)
...
![1631255110375](https://cdn.jsdelivr.net/npm/itheima-ssm/assets/1631255110375.png)
